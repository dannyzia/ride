  ...
  return (
    <SafeAreaView className="flex-1 bg-goBgLight dark:bg-goBgDark">
      <View className="flex-row items-center px-[24px] py-[16px] border-b border-goBorderLight dark:border-goBorderDark">
        ...
        <Text className="flex-1 text-center text-[18px] font-JakartaBold text-goTextPrimaryLight dark:text-goTextPrimaryDark">Hotspot Map</Text>
      ...
      <View className="flex-1 items-center justify-center px-[24px]">
        ...
        <Text className="text-[15px] font-Jakarta text-goTextSecondaryLight dark:text-goTextSecondaryDark text-center">
          Live demand heatmap and surge pricing will be available in a future update.
        </Text>
      </View>
    </SafeAreaView>
  );
