...
interface SOSButtonProps {
  /** Whether the driver is currently online / active. Button is disabled when false. */
  disabled?: boolean;
}
    ...
    async (contact: SOSContact) => {
      ...
      try {
        ...
        try {
          ...
          // Location unavailable — still send SOS with 0,0
        }
        ...
        // Close sheet and open phone dialer (convert to international format)
        setVisible(false);
    ...
    <>
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          height: 56,
          borderRadius: 28,
          backgroundColor: disabled ? colors.textDisabledLight : colors.danger,
