...
export default function AlternativesSheet({ visible, alternatives, onSelect, onCancel }: AlternativesSheetProps) {
  ...
  return (
    <View className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl p-6 shadow-xl z-50">
      <Text className="text-lg font-JakartaBold text-goTextPrimaryLight text-center mb-2">
        No drivers available
      </Text>
      <Text className="text-sm font-Jakarta text-gray-500 text-center mb-4">
          ...
          return (
            ...
            >
              <View className="flex-1">
                <Text className="text-base font-JakartaBold text-goTextPrimaryLight">
      ...
      >
        <Text className="text-sm font-Jakarta text-goDanger font-semibold">Cancel Request</Text>
      </TouchableOpacity>
    </View>
  );
}
